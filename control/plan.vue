   ...
   <section v-ui>
     <header>
       ...
       <input
        ...
        @change='capture'
        capture>
        <span v-if='sheetSize' v-sign>{{sheetSize}}</span>
         ...
         <div v-control>
           ...
           <table v-props>
             <thead>
               <tr>
                 <th>総括</th>
                 <th colspan='3'>連絡事項</th>
              </tr>
            </thead>
             <tbody>
               <tr>
                 <td><input type='text' v-model='dbTable.総括.名前'></td>
                 <td colspan='3'><input type='text' v-model='dbTable.総括.連絡'></td>
              </tr>
             </tbody>
           </table>
           <table v-props>
             ...
             <tbody>
               <tr>
                 <td><input type='tel'  v-model='dbTable.担当.階数'></td>
                 <td><input type='text' v-model='dbTable.担当.上司'></td>
                 <td><input type='text' v-model='dbTable.担当.自分'></td>
                 <td>
